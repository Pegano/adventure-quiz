...
const ANIMALS = [
  { id:'orangutan',      name:'Orangutan',            name_nl:'Orang-oetan',          emoji:'🦧', bg:'#3d2100',
    impostors:    ['Bornean Gibbon', 'Siamang', 'Sumatran Orangutan'],
    impostors_nl: ['Borneogibon', 'Siamang', 'Sumatraanse Orang-oetan'],
  ...
  { id:'tapir',          name:'Malayan Tapir',         name_nl:'Maleise Tapir',         emoji:'🐾', bg:'#1a2a1a',
    impostors:    ["Brazilian Tapir", "Mountain Tapir", "Baird's Tapir"],
    impostors_nl: ["Braziliaanse Tapir", "Bergtapir", "Baird's Tapir"],
  ...
  { id:'proboscis',      name:'Proboscis Monkey',      name_nl:'Neusaap',               emoji:'🐒', bg:'#2a1f0a',
    impostors:    ['Silvered Leaf Monkey', 'Pig-tailed Macaque', 'Bornean Gibbon'],
    impostors_nl: ['Zilverbladaap', 'Varkensstaartige Makaak', 'Borneogibon'],
  ...
  { id:'pygmy_elephant', name:'Borneo Pygmy Elephant', name_nl:'Borneo Dwergolifant',   emoji:'🐘', bg:'#1a2a2a',
    impostors:    ['Asian Elephant', 'Sumatran Elephant', 'Forest Elephant'],
    impostors_nl: ['Aziatische Olifant', 'Sumatraanse Olifant', 'Bosolifant'],
  ...
  { id:'sun_bear',       name:'Sun Bear',              name_nl:'Maleise Honingbeer',    emoji:'🐻', bg:'#2a1500',
    impostors:    ['Asian Black Bear', 'Sloth Bear', 'Honey Badger'],
    impostors_nl: ['Aziatische Zwarte Beer', 'Lippenbeer', 'Honingdas'],
  ...
  { id:'clouded_leopard',name:'Clouded Leopard',       name_nl:'Nevelpanter',           emoji:'🐆', bg:'#2a200a',
    impostors:    ['Leopard Cat', 'Marbled Cat', 'Flat-headed Cat'],
    impostors_nl: ['Luipaardkat', 'Marmeren Kat', 'Platkoppe Kat'],
  ...
  { id:'hornbill',       name:'Rhinoceros Hornbill',   name_nl:'Neushoornhoornvogel',   emoji:'🦜', bg:'#001a0a',
    impostors:    ['Great Hornbill', 'Helmeted Hornbill', 'Bushy-crested Hornbill'],
    impostors_nl: ['Grote Neushoornvogel', 'Gehelmd Neushoornvogel', 'Kuifneushoornvogel'],
  ...
  { id:'firefly',        name:'Firefly',               name_nl:'Vuurvliegje',           emoji:'✨', bg:'#000a1a',
    impostors:    ['Glow Worm', 'Lantern Bug', 'Click Beetle'],
    impostors_nl: ['Glimworm', 'Lantaarnvlieg', 'Kniptor'],
  ...
  { id:'crocodile',      name:'Saltwater Crocodile',   name_nl:'Zoutwaterkrokodil',     emoji:'🐊', bg:'#0a1a0a',
    impostors:    ['Mugger Crocodile', 'False Gharial', 'Nile Crocodile'],
    impostors_nl: ['Moeraskrokodil', 'Valse Gaviaal', 'Nijlkrokodil'],
  ...
  { id:'cobra',          name:'King Cobra',            name_nl:'Koningscobra',          emoji:'🐍', bg:'#1a1a00',
    impostors:    ['Reticulated Python', 'Banded Krait', 'Spitting Cobra'],
    impostors_nl: ['Netvormige Python', 'Gestreepte Krait', 'Spuwende Cobra'],
  ...
  { id:'pitcher',        name:'Pitcher Plant',         name_nl:'Bekerplant',            emoji:'🌿', bg:'#001a00',
    impostors:    ['Nepenthes lowii', 'Nepenthes rafflesiana', 'Giant Pitcher Plant'],
    impostors_nl: ['Nepenthes lowii', 'Nepenthes rafflesiana', 'Reuzenbekerplant'],
  ...
  { id:'colugo',         name:'Colugo',                name_nl:'Colugo',                emoji:'🦇', bg:'#0a0a1a',
    impostors:    ['Giant Flying Squirrel', 'Malayan Flying Squirrel', 'Philippine Flying Lemur'],
    impostors_nl: ['Reuzen Vliegende Eekhoorn', 'Maleise Vliegende Eekhoorn', 'Filipijnse Vliegende Maki'],
  ...
  { id:'slow_loris',     name:'Slow Loris',            name_nl:'Trage Lori',            emoji:'🌙', bg:'#100a1a',
    impostors:    ['Philippine Tarsier', 'Pygmy Slow Loris', 'Bengal Slow Loris'],
    impostors_nl: ['Filipijns Spookdiertje', 'Dwerg Trage Lori', 'Bengaalse Trage Lori'],
  ...
  { id:'pangolin',       name:'Pangolin',              name_nl:'Schubdier',             emoji:'🦔', bg:'#1a0a00',
    impostors:    ['Three-banded Armadillo', 'Giant Armadillo', 'Chinese Pangolin'],
    impostors_nl: ['Driebandig Gordeldier', 'Reuzen Gordeldier', 'Chinees Schubdier'],
  ...
  { id:'flying_fox',     name:'Giant Flying Fox',      name_nl:'Reuzen-vleerhond',      emoji:'🦇', bg:'#0a0010',
    impostors:    ['Indian Flying Fox', 'Large Flying Fox', 'Lesser Short-nosed Fruit Bat'],
    impostors_nl: ['Indiase Vleerhond', 'Grote Vleerhond', 'Kleine Kortsnuitvleermuis'],
  ...
  { id:'sea_turtle',     name:'Green Sea Turtle',      name_nl:'Groene Zeeschildpad',   emoji:'🐢', bg:'#00151a',
    impostors:    ['Hawksbill Sea Turtle', 'Leatherback Sea Turtle', 'Loggerhead Sea Turtle'],
    impostors_nl: ['Karetschildpad', 'Lederschildpad', 'Onechte Karetschildpad'],
  ...
  { id:'binturong',      name:'Binturong',             name_nl:'Binturong',             emoji:'🐈', bg:'#150a05',
    impostors:    ['Asian Palm Civet', 'Malay Civet', 'Masked Palm Civet'],
    impostors_nl: ['Aziatische Palmcivet', 'Maleise Civet', 'Gemaskerde Palmcivet'],
  ...
  { id:'macaque',        name:'Long-tailed Macaque',   name_nl:'Langstaartige Makaak',  emoji:'🐵', bg:'#1a1000',
    impostors:    ['Pig-tailed Macaque', 'Stump-tailed Macaque', 'Rhesus Macaque'],
    impostors_nl: ['Varkensstaartige Makaak', 'Stompstaartige Makaak', 'Resusaap'],
  ...
  { id:'fiddler_crab',   name:'Fiddler Crab',          name_nl:'Wenkkrab',              emoji:'🦀', bg:'#001510',
    impostors:    ['Ghost Crab', 'Mud Crab', 'Soldier Crab'],
    impostors_nl: ['Spookkrab', 'Modderkrab', 'Soldatenkrab'],
  ...
  { id:'hornbill2',      name:'Wreathed Hornbill',     name_nl:'Kranshoornvogel',       emoji:'🐦', bg:'#0a1500',
    impostors:    ['Black Hornbill', 'Oriental Pied Hornbill', 'White-crowned Hornbill'],
    impostors_nl: ['Zwarte Neushoornvogel', 'Oosterse Bonte Neushoornvogel', 'Witgekruinde Neushoornvogel'],
...
const DANGER_ANIMALS = [
  ...
  { id:'stonefish',       name:'Stonefish',             name_nl:'Steenvis',             gif:'stonefish',        emoji:'🐟', danger:9,
  ...
  { id:'reticulated_python', name:'Reticulated Python', name_nl:'Netvormige Python',   gif:'reticulated_python', emoji:'🐍', danger:8,
  ...
  { id:'pit_viper',       name:'Malayan Pit Viper',     name_nl:'Maleise Groefadder',  gif:'pit_viper',        emoji:'🐍', danger:7,
  ...
  { id:'giant_hornet',    name:'Giant Hornet',          name_nl:'Reuzenhoornaar',       gif:'giant_hornet',     emoji:'🐝', danger:6,
...
const App = (() => {
  ...
  function nextAnimalQ() {
    ...
    if (isCorrect) {
      ...
      // Pick a visually confusable impostor name
      const impostors = LANG === 'nl'
        ? (animal.impostors_nl || animal.impostors || [])
        : (animal.impostors || []);
      if (impostors.length > 0) {
        displayName = impostors[Math.floor(Math.random() * impostors.length)];
      } else {
        displayName = animalName(ANIMALS.filter(a => a.id !== animal.id)[Math.floor(Math.random() * (ANIMALS.length - 1))]);
      }
    }
